...
/* Define to 1 to enable clipboard copy/paste, may require pdcurses unless C_NOPDCLIP is set below */
...
/* Define to 1 to not use pdcurses for the clipboard feature (xclip will be required for Linux/BSD) */
#define C_NOPDCLIP 1
